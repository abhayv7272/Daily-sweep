...
def _demo_data():
    ...
    sweep_tail = [(104.2, 104.6, 103.4, 103.6, 1_000_000),   # decline into the swing low
                  ...
                  (101.8, 103.0, 99.35, 102.6, 1_800_000)]   # THE SWEEP of 100.00

    sweep_tail2 = [(205.0, 205.4, 203.2, 203.5, 900_000),
                   (203.5, 203.8, 202.0, 202.3, 950_000),
                   (202.3, 202.5, 200.0, 200.4, 1_100_000),  # swing low 200.00
                   (200.4, 201.3, 200.2, 200.9, 1_000_000),
                   (200.9, 201.7, 200.6, 201.4, 1_000_000),
                   (201.4, 202.2, 201.1, 201.9, 1_000_000),
                   (201.9, 202.6, 201.6, 202.2, 1_000_000),
                   (202.2, 202.8, 201.9, 202.4, 1_000_000),
                   (202.4, 202.7, 201.8, 202.3, 1_000_000),
                   (201.7, 204.1, 199.20, 203.4, 2_100_000)] # sweep of 200, strong close
